...
## 📚 추가 학습 자료를 공유합니다.
- [[coding apple] Next.js의 Server actions 기능](https://codingapple.com/unit/nextjs-server-actions/)
- [[Next.js] Server Actions and Mutations](https://nextjs-ko.org/docs/app/building-your-application/data-fetching/server-actions-and-mutations)